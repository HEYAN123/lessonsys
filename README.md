...
- [1. 课程教学质量评测反馈系统](#1-课程教学质量评测反馈系统)
  - [1.1. 登录与个人信息](#11-登录与个人信息)
    ...
    - [1.1.5. 修改密码](#115-修改密码)
  - [1.2. 学生端](#12-学生端)
    - [1.2.1. 获取投票列表](#121-获取投票列表)
    - [1.2.2. 获取投票/评价系统状态](#122-获取投票评价系统状态)
    - [1.2.3. 获取投票题目](#123-获取投票题目)
    - [1.2.4. 投票动作](#124-投票动作)
    - [1.2.5. 评价动作](#125-评价动作)
  - [1.3. 教师端](#13-教师端)
    - [1.3.1. 获取课程-班级列表](#131-获取课程-班级列表)
    - [1.3.2. 获取某班选某课学生列表](#132-获取某班选某课学生列表)
    - [1.3.3. 添加班级](#133-添加班级)
    - [1.3.4. 查看投票结果](#134-查看投票结果)
    - [1.3.5. 查看评价列表](#135-查看评价列表)
    - [1.3.6. 删除班级](#136-删除班级)
  - [1.4. 浏览端](#14-浏览端)
    - [1.4.1. 投票统计](#141-投票统计)
    - [1.4.2. 获取教师名单](#142-获取教师名单)
    - [1.4.3. 评价列表](#143-评价列表)
    - [1.4.4. 投票结果导出](#144-投票结果导出)
  - [1.5. 管理端](#15-管理端)
    - [1.5.1. 开关投票/评价系统](#151-开关投票评价系统)
    - [1.5.2. 教学管理](#152-教学管理)
      - [1.5.2.1. 获取教学列表](#1521-获取教学列表)
